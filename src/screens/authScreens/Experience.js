...
const Content = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.contentScroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps='handled'>
                ...
                <Text style={styles.StuTxt}> Teaching Experience </Text>
            ...
            >
                <Picker.Item label="School/University" enabled={false} color="grey" />
                <Picker.Item label="University1" value="University1" />
                <Picker.Item label="University2" value="University2" />
            </Picker>
            <Picker
                selectedValue={state}
                mode="dropdown"
                ...
                style={{ backgroundColor: '#f5f5f5', marginBottom: 10, }}
            >
                <Picker.Item label="Experience" enabled={false} color="grey" />
                <Picker.Item label="1" value="1" />
                <Picker.Item label="2" value="2" />
            </Picker>

            <Button title={'Continue'} onPress={() => {navigation.navigate('UpdatePassword')}} />
        </ScrollView>
    )
}
