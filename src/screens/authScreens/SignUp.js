import { StyleSheet, Text, View, ScrollView, Image, TouchableOpacity, TouchableHighlight, ImageBackground } from 'react-native'
    ...
    return (
        <ScrollView style={styles.contentScroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps='handled'>
            ...
            <View style={styles.teacher}>
                ...
                >
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <Text style={styles.StuTxt}>Student’s Sign Up</Text>
                        <Icon name='arrow-forward-circle' color={'#1D5500'} size={30} />
                    </View>
                </TouchableHighlight>
            </View>
            <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 30 }}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Login1')}>
                    <Text style={[styles.subHeading, { color: '#FB8500', marginLeft: 5 }]}>Login</Text>
                </TouchableOpacity>
            </View>
        </ScrollView>
    )
